...
// spotifyController.get('/player/next', authenticate, async (req, res) => {


//     try {
//         await spotifyApi2.skipToNext();
//         console.log('Skipped to next track');
//       } catch (error) {
//         console.error('Error skipping to next:', error);
        
//         if (error.statusCode === 403) {
//           console.log('No premium account or no active device');
...
// spotifyController.get('/player/prev', authenticate, async (req, res) => {


//     try {
//         await spotifyApi2.skipToPrevious();
...
// spotifyController.get('/player/mute', authenticate, async function (req, res) {
//     try {
//         spotifyApi2.getMyCurrentPlaybackState()
//         .then(function (data) {
...
//             spotifyApi2.setVolume(newPorcVol)
//         })        
//     } catch (error) {
//         res.status(400).json({ error: error.message });
//     }
